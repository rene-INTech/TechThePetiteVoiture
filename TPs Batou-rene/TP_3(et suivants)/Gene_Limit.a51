...
;V0: précharge du compteur à l'état bas
V0_Init_H   equ 			0FCh
...
UP				bit			P1.1
Gene			bit			P3.0
MODIF			bit			F0						;modification autorisée si MODIF à 1
...
si_MODIF:	JNB			MODIF,fsi_MODIF		;condition vérifiée si MODIF vaut 1
				MOV			A,#20
...
Init:
		      ...
		      ;On commence par l'étape 1, pour laquelle Gene est à 0
		      CLR			Gene
		      CLR			Etape
